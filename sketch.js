...
function blueBalloon() {
  ...
  blue.velocityX = 3;
  blue.lifetime = 150;
  blue.scale = 0.1;//write code for spwaning blue balloons
  blueBalloonGroup.add(blue)// blueBalloonGroup.add(blue)
}
...
function greenBalloon() {
  ...
  green.velocityX = 3;
  green.lifetime = 150;
  green.scale = 0.1;//write code for spwaning green balloons
...
function pinkBalloon() {
  ...
  pink.velocityX = 3;
  pink.lifetime = 150;
  pink.scale = 0.1;//write code for spwaning pink balloons
